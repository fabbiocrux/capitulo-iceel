...
Une approche usuelle pour classer les différents types de technologies de la FA, est à travers de la prise en compte de l’état initial de la matière première utilisée. Dans ce travail nous ne considérerons pas les procédés impliquant les matières métalliques et nous ferons  un focus sur  sur les procédés quiutilisent les polymères tel que visible dans la classification proposée à la la figure \@ref(fig:am-processes).


```{r am-processes, fig.cap="Classification des technologies de la FA. Adaptation de [@CruzSanchez2020]"}
#knitr::include_graphics(paste0(URL, "AM/AM-Processes-00-fr.png"))
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/AM/AM-Processes-00-fr.png", "Figures/AM-Processes-00-fr.png")
knitr::include_graphics("Figures/AM-Processes-00-fr.png")
```
...
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/AM/Printers/FFF/Darwin-00.jpg", "Figures/Darwing-RepRap.jpg")
knitr::include_graphics("Figures/Darwing-RepRap.jpg")
```
...
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/AM/3DP-growth.png", "Figures/3DP-growth.png")
knitr::include_graphics("Figures/3DP-growth.png")
```
...
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Recycling/fr/Multiple-Processing.jpg", "Figures/Multiple-Processing.jpg")
knitr::include_graphics("Figures/Multiple-Processing.jpg")
```
...
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Recycling/fr/Quality-Recycling.jpg", "Figures/Quality-Recycling.jpg")
knitr::include_graphics("Figures/Quality-Recycling.jpg")
```
...
```{r slr-methodology, fig.cap="Cadre conceptuel du processus technique sur le récyclage distribué"}
#knitr::include_graphics(paste0(URL, 'DRAM/DRAM-10.png'))
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/DRAM/DRAM-10.png", "Figures/DRAM-10.png")
knitr::include_graphics("Figures/DRAM-10.png")
```
...
#knitr::include_graphics(paste0(URL, 'Recycling/fr/Recycling-Methodology.png'))

#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Recycling/fr/Recycling-Methodology.png", "Figures/Recycling-Methodology-Fr.png")

knitr::include_graphics("Figures/Recycling-Methodology-Fr.png")
...
## Étape 2 : "Définition des procédés"

Cette étape est divisée en deux parties : 

1. ***Identification des procédés de recyclage*** : 
...
## Étape 3 : "Fabrication des échantillons"

Deux types de procédés sont proposés afin de comparer la dégradation de la matière : les procédés *Standard* et *l'Impression 3D*:
...
## Étape 1 - Définition du Matériau: L'acide Polylactique (PLA)
...
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Recycling/fr/Recycling-Process-Chains.jpg", "Figures/Recycling-Process-Chains.jpg")
knitr::include_graphics("Figures/Recycling-Process-Chains.jpg")
```
...
```{r extrusion, fig.cap="Procédé d’extrusion pour la création de filament ", out.width='100%'}
#knitr::include_graphics(paste0(URL, 'Extrusion-process/Extrusion-process-00.png'))
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Extrusion-process/Extrusion-process-00.png", "Figures/Extrusion-process-00.png")

knitr::include_graphics("Figures/Extrusion-process.jpg")
```
...
## Étape 3 - Fabrication des Échantillons
### Standard: Micro-compoundage et injection

Le procédé de micro-compoundage a été sélectionné comme notre procédé de fabrication standard (Figure \@ref(fig:Compounding)) . Il fournit une base de comparaison entre les différents matériaux recyclés. 
...
```{r Compounding, fig.cap="Procédé de micro-compoundage"}
knitr::include_graphics("Figures/Compounding.jpg")
```
...
```{r printers, fig.cap="Imprimantes Open source Foldarap et Mondrian", out.height= '200px'}
#knitr::include_graphics(c(paste0(URL, 'AM/Printers/FFF/Foldarap-00.jpg'),
#                        paste0(URL, 'AM/Printers/FFF/Mondrian-00.jpg'))
#                        )
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/AM/Printers/FFF/Foldarap-00.jpg", "Figures/Foldarap-00.jpg")
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/AM/Printers/FFF/Mondrian-00.jpg", "Figures/Mondrian-00.jpg")

knitr::include_graphics("Figures/Machines.jpg")
```
...
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/AM/Process/Parametros.png", "Figures/Parametros.png")
knitr::include_graphics("Figures/Parametros.png")
```
...
- **Épaisseur de la couche** : Il s'agit de la hauteur de la couche déposée par la buse.  
...
- **Vitesse de la tête d'impression** : C'est la vitesse de la buse de l'imprimante lorsqu'elle fabrique l'objet. (Vitesse des périmètres, petits périmètres, périmètres externes, remplissage - couches solides, supérieures, inférieures)
...
## Étape 4 - Évaluation: Propriétés mécaniques 
...
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Green-Fablab/14-Quality/Tensile/Sample/Dimensions-00.png", "Figures/Mechanical-sample.png")
knitr::include_graphics("Figures/Mechanical-sample.png")
```
...
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Green-Fablab/18-Recycling/Recycling-00.jpg", "Figures/Recycling-00.jpg")
knitr::include_graphics("Figures/Recycling-00.jpg")
```
...
```{r Samples, fig.cap="Eprouvettes de la chaine de recyclage de Standard et de l'Impression 3D", out.height='400px'}
#knitr::include_graphics(c(paste0(URL, 'Thesis/Reference/Compounding_4.jpg'),paste0(URL, 'Thesis/3DP/Figure-11a.png')))
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Thesis/Reference/Compounding_4.jpg", "Figures/Compounding_4.jpg")
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Thesis/3DP/Figure-11a.png", "Figures/Printed.jpg")

knitr::include_graphics("Figures/Echantillons.jpg")
...
```{r Ref-3DP, fig.cap="Propriétés mécaniques des pour les chaînes *Réference* et *3D Printing*", fig.subcap=c("Résistence à tension", "Module elastique"), out.width='100%'}
...
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Thesis/fr/Ref-3DP-Tensile-Strength.jpg", "Figures/Ref-3DP-Tensile-Strength.jpg")
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Thesis/fr/Ref-3DP-Elastic-Modulus.jpg", "Figures/Ref-3DP-Elastic-Modulus.jpg")

knitr::include_graphics("Figures/Resultas-1.jpg")
```
...
```{r Feed-3DP, fig.cap="Valeurs moyennes de résistance à la traction et module de elastiue pour les chaînes *Feedstock* et *3D printing (Réference)", out.width='100%'}
...
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Thesis/fr/Fed-3DP-Tensile-Strength.jpg", "Figures/Fed-3DP-Tensile-Strength.jpg")
#download.file("https://raw.githubusercontent.com/fabbiocrux/Figures/main/Thesis/fr/Fed-3DP-Elastic-Modulus.jpg", "Figures/Fed-3DP-Elastic-Modulus.jpg")
